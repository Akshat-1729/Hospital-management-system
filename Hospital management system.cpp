...
void appointment::brief_concern(){
	...
	cout<<"_______________________________________________xxx_______________________________________________\n";
	cout<<"Write here:-  ";
	fflush(stdin);
	gets(brief_con);
	cout<<"_______________________________________________xxx_______________________________________________\n\n";
...
void appointment::display_brief(){
	...
	cout<<"_______________________________________________xxx_______________________________________________\n";
	cout<<brief_con;
	cout<<"\n_______________________________________________xxx_______________________________________________\n\n";
}
